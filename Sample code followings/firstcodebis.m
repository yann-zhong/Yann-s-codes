...
%target = rgb2gray(imread('1.jpg'));                      % Why rgb2gray? only grayscale?
target = double(imread('1.jpg'));                                       % reconversion for using fftshift
imshow('1.jpg');
imshow(target);
...
figure;
subplot(2,3,1);
imshow('1.jpg');                                         % Shows OG image (in color)
